...
graph [
  ...
  node [
    ...
    gid -1
    graphics [ fill "#4c95b6" w 150 ]
  ]
  node [
    id 1
    LabelGraphics [ text "A-FOp-bs" fontSize 14 ]
    gid -1
    graphics [ fill "#4ca6a5" w 150 ]
  ]
  node [
    id 16
  ...
  node [
    ...
    gid -1
    graphics [ fill "#55f64c" w 150 ]
  ]
  node [
    id 0
    LabelGraphics [ text "A-HAm-cib" fontSize 14 ]
    gid -9
    graphics [ fill "#60eb4c" w 150 ]
  ]
  node [
    id 15
