...
graph [
  ...
  edge [
    ...
    LabelGraphics [ text "12" fontSize 14 fontStyle "bold" model "centered" position "center" outline "#000000" fill "#FFFFFF"]
  ]
  edge [
    source 2
    target 9
    graphics [ style "line" arrow "last" width 7 fill "#0010ee" ]
    LabelGraphics [ text "6" fontSize 14 fontStyle "bold" model "centered" position "center" outline "#000000" fill "#FFFFFF"]
  ]
  edge [
    source 3
    target 9
  ...
  edge [
    ...
    LabelGraphics [ text "3" fontSize 14 fontStyle "bold" model "centered" position "center" outline "#000000" fill "#FFFFFF"]
  ]
  edge [
    source 6
    target 5
